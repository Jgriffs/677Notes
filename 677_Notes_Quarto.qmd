...
*Expected loss* is a key concept in decision theory, used to quantify some amount of utility that is lost as a result of a certain action. Chapter 5 of Chernoff & Moses touches on this concept, though not in a strictly game theory context.

# Data

First, some data from the tables featured in Chapter 5 will be created.
...
**Bayes Strategy**
5.6: $L(s)=(1-w)L(\theta_1,s)+wL(\theta_2,s)$
  
## Bayes Strategy Function
```{r}
...
$1$ Chernoff, H., & Moses, L. E. (1959). Elementary decision theory. John Wiley
